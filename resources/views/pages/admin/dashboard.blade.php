      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card stat-card p-3">
          <div class="d-flex align-items-center">
            <div class="stat-icon me-3" style="background: {{ $stat['bg'] }}">
              <i class="{{ $stat['icon'] }}"></i>
            </div>
            <div>
          ...
          <tbody>
            @forelse($recentOrders as $index => $order)
              ...
              <tr>
                ...
                {{-- Fulfillment Status --}}
                <td>
                  <span class="badge bg-{{ $statusColors[$order->fulfillment_status] ?? 'secondary' }}">
...
<script>
  ...
  const chartOrders = new ApexCharts(document.querySelector("#chart-orders"), {
    ...
    markers: { size: 5 },
    series: [{ name: "Đơn hàng", data: @json($monthlyOrders) }],
    xaxis: { categories: ['T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','T11','T12'] },
    colors: ['#4e73df'],
    grid: { borderColor: "#eee" },
