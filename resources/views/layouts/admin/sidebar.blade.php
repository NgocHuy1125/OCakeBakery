    ...
    <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="/" class="text-nowrap logo-img d-flex align-items-center">
                <img src="{{ asset('/images/logo.png') }}" class="img-fluid" width="60" height="60" alt="Kim Loan Cake logo" />
        ...
        <nav class="sidebar-nav scroll-sidebar min-vh-100" data-simplebar="">
            <ul id="sidebarnav">
                @if($userRole === 'admin')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link justify-content-between has-arrow {{ $catalogActive ? 'active' : '' }}"
                           href="javascript:void(0)" aria-expanded="{{ $catalogActive ? 'true' : 'false' }}">
                            <div class="d-flex align-items-center gap-3">
                                <span class="d-flex"><i class="ti ti-clipboard"></i></span>
                                <span class="hide-menu">Quản lý sản phẩm</span>
                            </div>
                        </a>
                        <ul aria-expanded="{{ $catalogActive ? 'true' : 'false' }}"
                            class="collapse first-level {{ $catalogActive ? 'show' : '' }}">
                            <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ $inventoryActive ? 'active' : '' }}"
                           href="{{ route('admin.restock.index') }}" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('admin.promotions.*') ? 'active' : '' }}"
                           href="{{ route('admin.promotions.index') }}" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('admin.contacts.*') ? 'active' : '' }}"
                ...
                @elseif($userRole === 'staff')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->routeIs('admin.offline-orders.*') ? 'active' : '' }}"
                           href="{{ route('admin.offline-orders.index') }}" aria-expanded="false">
