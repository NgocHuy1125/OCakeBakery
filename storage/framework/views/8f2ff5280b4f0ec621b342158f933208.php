...
<?php $__env->startSection('title', 'Bán hàng tại quầy'); ?>
...
<div class="py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-end small text-muted">
            <div><i class="fas fa-map-marker-alt me-1"></i><?php echo e($storeAddress); ?></div>
    ...
    <ul class="nav nav-pills mb-4" id="offlineTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link text-success <?php echo e($activeTab === 'orders' ? '' : 'active'); ?>" id="tab-pos-trigger" data-bs-toggle="tab" data-bs-target="#tab-pos" type="button" role="tab" aria-controls="tab-pos" aria-selected="<?php echo e($activeTab === 'orders' ? 'false' : 'true'); ?>">
                <i class="fas fa-cash-register me-1"></i> Bán hàng tại quầy
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link text-success <?php echo e($activeTab === 'orders' ? 'active' : ''); ?>" id="tab-orders-trigger" data-bs-toggle="tab" data-bs-target="#tab-orders" type="button" role="tab" aria-controls="tab-orders" aria-selected="<?php echo e($activeTab === 'orders' ? 'true' : 'false'); ?>">
    ...
    <div class="tab-content" id="offlineTabsContent">
        <div class="tab-pane fade <?php echo e($activeTab === 'orders' ? '' : 'show active'); ?>" id="tab-pos" role="tabpanel" aria-labelledby="tab-pos-trigger">
    <div class="row g-4">
        <div class="col-xl-6">
                ...
                <div class="card-body">
                    <div class="row row-cols-2 row-cols-md-3 g-3" id="productGrid">
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col product-card" data-product="<?php echo e($product['id']); ?>" data-name="<?php echo e(Str::lower($product['name'])); ?>">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="ratio ratio-1x1 bg-light rounded-top">
                                        <?php if($product['image']): ?>
                                            <img src="<?php echo e($product['image']); ?>" alt="<?php echo e($product['name']); ?>" class="rounded-top object-fit-cover">
                                        <?php else: ?>
                                    ...
                                    <div class="card-body d-flex flex-column p-3">
                                        ...
                                        <div class="text-muted small">Mã: <?php echo e($product['code'] ?? '---'); ?></div>
                                        <div class="fw-bold text-success my-2"><?php echo e(number_format($product['price'], 0, ',', '.')); ?> ₫</div>
                                        <button class="btn btn-sm btn-outline-success mt-auto" data-add-product="<?php echo e($product['id']); ?>"
                                                <?php if($product['stock'] <= 0): ?> disabled <?php endif; ?>>
                                            <i class="fas fa-cart-plus me-1"></i><?php echo e($product['stock'] > 0 ? 'Thêm vào đơn' : 'Hết hàng'); ?>
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'orders' ? 'show active' : ''); ?>" id="tab-orders" role="tabpanel" aria-labelledby="tab-orders-trigger">
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold"><i class="fas fa-list me-2 text-primary"></i>Danh sách đơn tại quầy</h5>
            <span class="text-muted small">Hiển thị <?php echo e($recentOrders->perPage()); ?> đơn mỗi trang</span>
        </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody id="recentOrdersBody">
                        <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr data-order-row>
                                <td>
                                    <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="text-decoration-none fw-semibold">#<?php echo e($order->order_code); ?></a>
                                    <div class="small text-muted"><?php echo e(optional($order->ordered_at ?? $order->created_at)->format('d/m/Y H:i')); ?></div>
                                </td>
                                <td>
                                    <div class="fw-semibold"><?php echo e($order->customer_name ?? 'Khách lẻ'); ?></div>
                                    <div class="small text-muted"><?php echo e($order->customer_phone ?? '---'); ?></div>
                                </td>
                                <td class="text-end fw-semibold text-success"><?php echo e(number_format($order->grand_total, 0, ',', '.')); ?> ₫</td>
                        ...
                        <tr id="recentOrdersEmpty" class="<?php echo e($recentOrders->isEmpty() ? '' : 'd-none'); ?>">
        ...
        <?php if($recentOrders->hasPages()): ?>
            <div class="card-footer bg-white">
                <?php echo e($recentOrders->appends([
                    'tab' => 'orders',
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo e(route('admin.offline-orders.index')); ?>" class="btn btn-success">Tạo đơn mới</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo json_encode($posFulfillmentStatuses, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>
...
(() => {
    ...
    const storeUrl = "<?php echo e(route('admin.offline-orders.store')); ?>";
    const statusMap = parseJsonElement('posStatusMapData', {});
    const MAX_RECENT_ORDERS = Number(<?php echo json_encode($recentOrders->perPage(), 15, 512) ?>);

    const paymentStatusBaseUrl = "<?php echo e(url('/payment/status')); ?>/";
...
<?php echo $__env->make('layouts.client.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KimLoanCake\resources\views/pages/client/offline-orders.blade.php ENDPATH**/ ?>