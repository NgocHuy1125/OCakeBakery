...
<div class="container py-5">
    <nav aria-label="breadcrumbs" class="mb-4">
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a class="nav-link" href="<?php echo e(url('/')); ?>" class="text-decoration-none">Trang chủ</a></li>
            ...
            <div class="card border-0 shadow-sm">
                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr data-cart-item="<?php echo e($item->id); ?>"
                                            data-update-url="<?php echo e(route('cart.items.update', $item)); ?>"
                                            data-delete-url="<?php echo e(route('cart.items.destroy', $item)); ?>">
                                            <td class="ps-4">
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?php echo e($item->product?->primary_image_url ?? asset('images/product.jpg')); ?>"
                                                         alt="<?php echo e($item->product->name ?? 'Sản phẩm'); ?>"
                                                         class="rounded"
                                                         style="width: 64px; height: 64px; object-fit: cover;">
                                                    <div>
                                                        <div class="fw-semibold"><?php echo e($item->product->name ?? 'Sản phẩm'); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <?php echo e(number_format($unitPrice, 0, ',', '.')); ?> đ
                                            </td>
                                            <td class="text-end pe-3">
                                                <div class="fw-semibold cart-line-total"><?php echo e(number_format($lineTotal, 0, ',', '.')); ?> đ</div>
                                            </td>
                ...
                <?php if($items->isNotEmpty()): ?>
                    <div class="card-footer bg-white d-flex justify-content-between align-items-center">
                        <button class="btn btn-outline-secondary btn-sm cart-clear-btn" data-url="<?php echo e(route('cart.clear')); ?>">
                            Xóa toàn bộ giỏ hàng
                        </button>
                        <a href="<?php echo e(route('products.index')); ?>" class="btn btn-link text-decoration-none">Tiếp tục mua sắm</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between align-items-center mb-2">
                            <span>Tạm tính</span>
                            <strong id="cartSubtotal"><?php echo e(number_format($totals['subtotal'], 0, ',', '.')); ?> đ</strong>
                        </li>
                        <li class="d-flex justify-content-between align-items-center mb-2">
                            <span>Phí vận chuyển</span>
                            <strong id="cartShipping"><?php echo e(number_format($totals['shipping'], 0, ',', '.')); ?> đ</strong>
                        </li>
                        <li class="d-flex justify-content-between align-items-center mb-2">
                            <span>Giảm giá</span>
                            <strong id="cartDiscount">-<?php echo e(number_format($totals['discount'], 0, ',', '.')); ?> đ</strong>
                        </li>
                        <li class="d-flex justify-content-between align-items-center border-top pt-3">
                            ...
                            <span class="fs-5 fw-bold text-success" id="cartGrandTotal">
                                <?php echo e(number_format($totals['grand_total'], 0, ',', '.')); ?> đ
                            </span>
                        </li>
                    </ul>

                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('checkout.show')); ?>" class="btn btn-success w-100 mb-2"
                           <?php if($items->isEmpty()): ?> disabled <?php endif; ?>>
                            Tiến hành đặt hàng
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-success w-100 mb-2">
...
<?php echo $__env->make('layouts.client.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KimLoanCake\resources\views/pages/client/cart.blade.php ENDPATH**/ ?>