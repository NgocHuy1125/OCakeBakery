<?php $__env->startSection('title', 'Quản lý nhập hàng'); ?>
      ...
      <table id="table" class="table align-middle mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="fw-semibold"><?php echo e($receipt->receipt_code); ?></td>
            <td><?php echo e($receipt->created_at->format('d/m/Y H:i')); ?></td>
            <td><?php echo e(number_format($totalCost, 0, ',', '.')); ?> ₫</td>
            <td class="text-end">
              <a href="<?php echo e(route('admin.restock.show', $receipt->id)); ?>" class="btn btn-sm btn-outline-dark">
...
<div class="modal fade" id="createRestockModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <form method="POST" action="<?php echo e(route('admin.restock.store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\OCakeBakery\resources\views/pages/admin/restock.blade.php ENDPATH**/ ?>