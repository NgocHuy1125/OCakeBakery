  ...
  <div class="container pt-5 pb-3">
    ...
    <div class="row g-4 d-flex justify-content-between">
      ...
      <div class="col-12 col-md-4">
        <a href="<?php echo e(url('/')); ?>" class="d-flex align-items-center gap-2 mb-3 text-decoration-none text-white">
          <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="rounded" style="height:40px;width:40px;object-fit:cover">
      ...
      <div class="col-6 col-md-3">
        ...
        <ul class="list-unstyled small">
          <li class="py-1"><a class="link-light link-underline-opacity-0" href="<?php echo e(url('/shipping')); ?>">Giao hàng</a></li>
          <li class="py-1"><a class="link-light link-underline-opacity-0" href="<?php echo e(url('/refund')); ?>">Đổi trả</a></li>
          <li class="py-1"><a class="link-light link-underline-opacity-0" href="<?php echo e(url('/faq')); ?>">FAQ</a></li>
          <li class="py-1"><a class="link-light link-underline-opacity-0" href="<?php echo e(url('/size-guide')); ?>">Kích thước bánh</a></li>
        </ul>
      </div>
    ...
    <p class="text-center small mb-0">Copyright © <?php echo e(date('Y')); ?> Tiệm Bánh Kim Loan. All rights reserved.</p>
  </div>
</footer>
<?php /**PATH D:\XAMPP\htdocs\OCakeBakery\resources\views/layouts/client/footer.blade.php ENDPATH**/ ?>